...
const StudentEditPage = () => {
            ...
            try {
                ...
                if (response && response.success && response.result) {
                    ...
                    setFormData({
                        ...
                        permanent_region_name: citizen?.address_permanent?.region?.name || '',
                        permanent_district_name: citizen?.address_permanent?.district?.name || '',
                        permanent_mahalla_name: citizen?.address_permanent?.mahalla?.name || '',
                        ...
                        school_certificate_serial: response.result.school_certificate_serial || '',
                        school_certificate_number: response.result.school_certificate_number || '',
                    ...
                    setSearchFormData({
                        ...
                        birth_date_cert_check: formatDateForDisplay(citizen?.birth_date) || ''
                    });
    ...
    const handleCheckCitizen = async (type) => {
        ...
        try {
            ...
            if (type === 'pinfl') {
                ...
                if (!searchFormData.passport_serial || !searchFormData.passport_number || !searchFormData.birth_date_check) {
                    setCheckError("Pasport seriyasi, raqami va Tug'ilgan sana to'ldirilishi shart.");
                    setLoading(false);
                    return;
                }
                apiUrl = 'students/info-by-passport/';
                payload = {
                    serial_number: searchFormData.passport_serial + searchFormData.passport_number,
                    birth_date: formatDateForAPI(searchFormData.birth_date_check)
                };
            ...
            if (response && response.success && response.result) {
                ...
                setFormData(prev => ({
                    ...
                    permanent_region_name: citizenData.address_permanent?.region?.name || '',
                    permanent_district_name: citizenData.address_permanent?.district?.name || '',
                    permanent_mahalla_name: citizenData.address_permanent?.mahalla?.name || '',
                }));
                setSuccessMessage("Fuqaro ma'lumotlari muvaffaqiyatli yuklandi!");
            } else {
                setCheckError("Ma'lumot topilmadi yoki xato yuz berdi: " + (response.error || 'Noma’lum xato'));
            }
        } catch (err) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (dataToUpdate.citizen?.citizenship_type) delete dataToUpdate.citizen.citizenship_type;
            if (dataToUpdate.edu_group?.institution) delete dataToUpdate.edu_group.institution;
            if (dataToUpdate.edu_group?.curriculum) delete dataToUpdate.edu_group.curriculum;
            if (dataToUpdate.citizen?.address_permanent?.region) delete dataToUpdate.citizen.address_permanent.region;
            if (dataToUpdate.citizen?.address_permanent?.district) delete dataToUpdate.citizen.address_permanent.district;
            if (dataToUpdate.citizen?.address_permanent?.mahalla) delete dataToUpdate.citizen.address_permanent.mahalla;
            ...
            if (response.success) {
                ...
                setError("Ma'lumotlarni yangilashda xatolik: " + (response.error || JSON.stringify(response.error_message) || 'Noma’lum xato'));
            }
        } catch (err) {
            console.error("Ma'lumotlarni yangilashda xatolik:", err);
            setError("Ma'lumotlarni yangilashda xatolik yuz berdi: " + (err.response?.data?.error || err.message));
        } finally {
            setLoading(false);
        }
    };
    ...
    return (
        <div className="p-4 bg-gray-100 dark:bg-gray-900 flex-1 overflow-y-auto text-gray-900 dark:text-gray-100">
            ...
            <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md mb-6">
                <h2 className="text-xl font-semibold mb-4 border-b pb-2 border-gray-200 dark:border-gray-700">Talaba shaxsiy ma'lumotlarini tekshirish</h2>
                {checkError && <p className="text-red-600 text-sm mb-4">{checkError}</p>}
                <div className="grid grid-cols-1  md:grid-cols-4 gap-4 mb-4">
                    <div className="flex flex-col ">
                        <label htmlFor="pinfl_check" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">JSHSHIR</label>
                        <div className="flex">
                            <input
                                type="text"
                                id="pinfl_check"
                        ...
                        <div className=' flex flex-col'>
                            <label htmlFor="birth_cert_serial_check" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Tug'ilgan sana</label>
                            <input
                                type="text"
                                id="birth_date_check"
                    ...
                    <div className="flex flex-col">
                        <label htmlFor="passport_serial_check" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Pasport seriyasi raqami</label>
                        <div className="flex ">
                            <input
                                type="text"
                ...
                <div className="grid grid-cols-1 md:grid-cols-5 gap-4 mb-4">
                    <div className="flex flex-col">
                        <label htmlFor="birth_cert_serial_check" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Tug'ilganlik guvohnomasi seriyasi</label>
                        <input
                            type="text"
                    ...
                    <div className="flex flex-col">
                        <label htmlFor="birth_cert_number_check" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Tug'ilganlik guvohnomasi raqami</label>
                        <input
                            type="text"
                    ...
                    <div className="flex flex-col">
                        <label htmlFor="birth_date_cert_check" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Tug'ilgan sana</label>
                        <div className="flex">
                            <input
                                type="text"
            ...
            <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
                ...
                <form id="editStudentForm" onSubmit={handleSubmit}>
                    <h3 className="text-lg font-semibold mb-3 mt-6 border-b pb-1 border-gray-200 dark:border-gray-700">Talaba shaxsiy ma'lumotlari</h3>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        <div className="mb-2">
                            <label htmlFor="last_name" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Familiyasi</label>
                            <input
                                type="text"
                                id="last_name"
                                name="last_name"
                        ...
                        <div className="mb-2">
                            <label htmlFor="first_name" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Ismi</label>
                            <input
                                type="text"
                                id="first_name"
                                name="first_name"
                        ...
                        <div className="mb-2">
                            <label htmlFor="middle_name" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Otasining ismi</label>
                            <input
                                type="text"
                                id="middle_name"
                                name="middle_name"
                        ...
                        <div className="mb-2">
                            <label htmlFor="citizenship_type_name" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Fuqarolik</label>
                            <input
                                type="text"
                    ...
                    <h3 className="text-lg font-semibold mb-3 mt-6 border-b pb-1 border-gray-200 dark:border-gray-700">Talabaning doimiy yashash ma'lumotlari</h3>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        <div className="mb-2">
                            <label htmlFor="permanent_region_name" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Viloyat</label>
                            <input
                                type="text"
                        ...
                        <div className="mb-2">
                            <label htmlFor="permanent_district_name" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Tuman</label>
                            <input
                                type="text"
                        ...
                        <div className="mb-2">
                            <label htmlFor="permanent_mahalla_name" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Mahalla</label>
                            <input
                                type="text"
                        ...
                        <div className="mb-2">
                            <label htmlFor="permanent_street" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Ko'cha</label>
                            <input
                                type="text"
                                id="permanent_street"
                    ...
                    <h3 className="text-lg font-semibold mb-3 mt-6 border-b pb-1 border-gray-200 dark:border-gray-700">Talabaning oldingi ta'limi ma'lumotlari</h3>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        <div className="mb-2">
                            <label htmlFor="school_name" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Bitirgan maktabi</label>
                            <input
                                type="text"
                                id="school_name"
                                name="school_name"
                        ...
                        <div className="mb-2">
                            <label htmlFor="school_region_name" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Maktab joylashgan viloyat</label>
                            <input
                                type="text"
                        ...
                        <div className="mb-2">
                            <label htmlFor="school_district_name" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Maktab joylashgan tuman</label>
                            <input
                                type="text"
                        ...
                        <div className="mb-2">
                            <label htmlFor="graduation_year" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Maktabni bitirgan yil</label>
                            <input
                                type="number"
                                id="graduation_year"
                        ...
                        <div className="mb-2">
                            <label htmlFor="school_certificate_serial" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Maktab attestati seriyasi</label>
                            <input
                                type="text"
                        ...
                        <div className="mb-2">
                            <label htmlFor="school_certificate_number" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Maktab attestati raqami</label>
                            <input
                                type="text"
                    ...
                    <h3 className="text-lg font-semibold mb-3 mt-6 border-b pb-1 border-gray-200 dark:border-gray-700">Talabaning hozirgi ta'limi ma'lumotlari</h3>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        <div className="mb-2">
                            <label htmlFor="edu_group_name" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Guruh nomi</label>
                            <input
                                type="text"
                                id="edu_group_name"
                                name="edu_group_name"
                        ...
                        <div className="mb-2">
                            <label htmlFor="admission_year" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">O'qishga kirgan yili</label>
                            <input
                                type="number"
                                id="admission_year"
                                name="admission_year"
                        ...
                        <div className="mb-2">
                            <label htmlFor="status" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Talaba holati</label>
                            <select
                                id="status"
                                name="status"
                        ...
                        <div className="mb-2">
                            <label htmlFor="edu_type_dummy" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Ta'lim turi (Misol)</label>
                            <input
                                type="text"
                                id="edu_type_dummy"
                                name="edu_type_dummy"
