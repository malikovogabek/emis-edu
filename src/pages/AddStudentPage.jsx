        ...
        <div className="h-screen w-full overflow-y-auto p-4 bg-gray-100 dark:bg-gray-900 space-y-6">
            <Card className="shadow-md">
                ...
                <Form layout="vertical" form={form} className="grid grid-cols-1 md:grid-cols-4 gap-3">
                    ...
                    <Form.Item
                        label={t("birthDateWithPinflLabel")}
                        name="birth_date"
                    ...
                    <Form.Item
                        label={t("birthDateWithCertLabel")}
            ...
            <div className="flex justify-between items-center my-3 mx-3">
                <h2 className="text-xl font-semibold text-gray-800 dark:text-white">{t("addstudent")}</h2>
                <div className="space-x-2">
                    <Button type="primary" onClick={handleSaveStudent}>{t("Addstaffs.saqlash")}</Button>

                    <Button danger onClick={() => navigate("/study-process/students")}>{t("backButton")}</Button>
                </div>
            </div>
